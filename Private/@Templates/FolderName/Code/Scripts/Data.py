...
RULE_REDUCTION_NOTES_COMMENT=f"! Reduction notes: Reduction amount reflects entries reduced by wildcard and regex replacements.\n! -- See \"Source: Regex/Rules/combined.txt\" in this file for reference."
