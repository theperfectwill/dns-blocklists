...
# Create our extractMostCommonPhrases function
function extractMostCommonPhrases() {

    # Set our variables
    local thisPath="$regexPath/$sortedPath"
    local mostCommonFile="$thisPath/extractMostCommon.py"

    # Call extractMostCommon.py with our desired outputs
...
# Call our extractMostCommonPhrases function
extractMostCommonPhrases
